...
class User(Base):
    ...
    hilos = relationship("Thread", back_populates="usuarios")
    likes = relationship("Like", back_populates="usuarios")
    comentarios = relationship("Coment", back_populates="usuarios")
